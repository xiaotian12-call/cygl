...
<div>
    <table class="layui-table" style="padding-left: 5px;padding-right: 5px">
        ...
        <form class="layui-form" action="xmsh?method=zdjsHtsh"  method="post">
            <input type="text" name="num" value="<%=jiben.get(0).getItem_num() %>" hidden="hidden">
        <tr>
            <td >审核意见</td>
            <td colspan="3">
                <textarea style="width: 100%;height: 100%" class="layui-textarea" name="psyj"></textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="layui-input-block">
                    <input type="radio" name="sftg" value="1" title="通过" >通过
                    <input type="radio" name="sftg" value="0" title="不通过">不通过
                </div>
            </td>
            <td colspan="2">
