...
<script type="text/html" id="barDemo">
    <a class="layui-btn  layui-btn-xs" lay-event="detail">评审</a>
    <%--    <a class="layui-btn layui-btn-xs" lay-event="edit">评审</a>--%>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                layer.open({
                    ...
                    title: '查看项目信息',
                    shadeClose: true, //点击遮罩关闭
                    content: 'xyzj_jtps.jsp?item_num='+data.item_num,
                });
                ...
                layer.open({
                    ...
                    title: '项目评审',
                    shadeClose: true, //点击遮罩关闭
                    content: 'item?method=getXmxx&num='+data.item_num,
                });
