...
<%
    ...
    String[] s1 = jiben.get(0).getItem_concluding_report().split("_");
...
<div class="content" style="width: 1200px;height: auto; margin-left: 10%">
    <div class="gd-container content" style="height: 60px;">
        <div class="gd-main">
            ...
            <span style="font-size: 20px;margin-top: 20px;margin-left: 40px">
                <a href="index.jsp" style="color: #8798ff; font-size: 20px;">首页</a>&nbsp;>>&nbsp;
                <a href="tzgg?method=getTzgg" style="color: #8798ff; font-size: 20px;">历年项目</a>
            </span>
            </div>
    ...
    <div style="margin-left: 30px;margin-right: 30px">
        <table class="layui-table" >
            ...
            <tr>
                <td >项目结题报告</td>
                <td colspan="3">
                    <a href="<%="DownLoadServlet?filename="+jiben.get(0).getItem_concluding_report()%>"><%=s1[1]%></a>
                </td>
            </tr>
