...
<div class="content">
    <div style="margin-left: 80px">
        <ul class="layui-nav layui-bg-green">
            ...
            <%--                </dl>--%>
            <%--            </li>--%>
            <li class="layui-nav-item layui-this"><a href="ListFileServlet">下载专区</a></li>
        </ul>
    </div>
</div>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div style="margin: 30px">
                        <form action="tzgg?method=cXm" method="post">
                            <div class="layui-form-item" >
                                <div class="layui-inline">
                                    <label class="layui-form-label">文件名</label>
                                    <div class="layui-input-inline">
                                        <input type="text" name="item_name" lay-verify="email" autocomplete="off" class="layui-input" >
                                    </div>
                                </div>
                            </div>
        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header" style="background: gainsboro">
                    ...
                    <label style="font-size: 18px">下载专区</label>
                </div>
                <div class="layui-card-body">
                    <table width="100%">
                        <ul class="list-unstyled">
                            <c:forEach var="me" items="${fileNameMap}">
                                ...
                                <tr style="width: 100%;">
                                    <td align="left">${me.value}</td>
                                    <td align="right" style="font-size: 12px"> <a href="${downurl}">下载</a></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <hr>
