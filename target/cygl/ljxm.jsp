...
<div class="content">
    <div style="margin-left: 80px">
        <ul class="layui-nav layui-bg-green">
            ...
            <li class="layui-nav-item layui-this"><a href="tzgg?method=xm">历届项目</a></li>
                       ...
                       <form action="tzgg?method=cXm" method="post">
                           ...
                           <div class="layui-form-item" >
                               <div class="layui-inline">
                                   ...
                                   <div class="layui-input-inline">
                                       <input type="text" name="leader_name" lay-verify="email" autocomplete="off" class="layui-input" >
                                   </div>
                               </div>
                           </div>
